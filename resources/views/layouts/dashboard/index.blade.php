...
<head>
    ...
    <title>LaraCMS</title>
    <link href="/dashboard/css/lib/bootstrap/bootstrap-rtl.min.css" rel="stylesheet">
...
<div id="main-wrapper">
                ...
                <ul class="navbar-nav my-lg-0">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="message-center">
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"><img src="/dashboard/images/users/5.jpg" alt="user"
                                        ...
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"><img src="/dashboard/images/users/2.jpg" alt="user"
                                                                       class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"><img src="/dashboard/images/users/3.jpg" alt="user"
                                                                       class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="#">
                                            <div class="user-img"><img src="/dashboard/images/users/4.jpg" alt="user"
                                                                       class="img-circle"> <span
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false"><img src="/dashboard/images/users/5.jpg" alt="user"
                                                                           class="profile-pic"/></a>
    ...
    <!-- End header header -->
    <!-- Left Sidebar  -->
    @include('layouts.dashboard.rightMenu')
    <!-- End Left Sidebar  -->
    <!-- Page wrapper  -->
